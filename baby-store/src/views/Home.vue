<template>
  <div class="main-wrapper box-layout">
        ...
        <div class="row row-10 mbn-20">
          ...
          <div class="col-lg-4 col-md-6 col-12 mb-20">
            <div class="banner banner-1 content-left content-top">
              <a href="#" class="image"
                ><img src="assets/images/banner/banner-3.jpg" alt="Banner Image"
              /></a>
              ...
              <div class="product-inner">
                ...
                <div class="content">
                  <div class="content-left">
                    ...
                    <h5 class="color">
                      Color: <span style="background-color: #ffb2b0"></span
      ...
      <div class="row row-5 mbn-10">
        <div class="col-lg-4 col-md-6 col-12 mb-10">
          <div class="banner banner-3">
            ...
            <div
              class="content"
              style="background-image: url(assets/images/banner/banner-3-shape.png)"
            >
              <h1>New Arrivals</h1>
              <h2>Up to 35% off</h2>
              <h4>2 - 5 Years</h4>
        ...
        <div class="col-lg-4 col-md-6 col-12 mb-10">
          <div class="banner banner-5">
            ...
            <div
              class="content"
              style="background-image: url(assets/images/banner/banner-5-shape.png)"
            >
    ...
    <div
      class="feature-section bg-theme-two section section-padding fix"
              ...
              <div class="col-12 mb-40">
                <div class="blog-item">
                  <div class="image-wrap">
                    ...
                    <a class="image" href="single-blog.html"
                  ...
                  <div class="content">
                    <h4 class="title">
                      <a href="single-blog.html"
                        >Lates and new Trens for baby fashion</a
                      >
                    </h4>
                    <div class="desc">
                      <p>
              ...
              <div class="col-12 mb-40">
                <div class="blog-item">
                  ...
                  <div class="content">
                    <h4 class="title">
                      <a href="single-blog.html"
                        >New Collection New Trend all New Style</a
                      >
                    </h4>
                    <div class="desc">
                      <p>
